...
public class BeamEntity extends AbstractArrow implements ItemSupplier {
	public static final ItemStack PROJECTILE_ITEM = new ItemStack(SuggestionsannesfansModItems.ULTAMITE.get());
	...
	public BeamEntity(EntityType<? extends BeamEntity> type, double x, double y, double z, Level world, @Nullable ItemStack firedFromWeapon) {
	...
	public BeamEntity(EntityType<? extends BeamEntity> type, LivingEntity entity, Level world, @Nullable ItemStack firedFromWeapon) {
	...
	public static BeamEntity shoot(Level world, LivingEntity entity, RandomSource source) {
		return shoot(world, entity, source, 100f, 100, 100);
	}

	public static BeamEntity shoot(Level world, LivingEntity entity, RandomSource source, float pullingPower) {
		return shoot(world, entity, source, pullingPower * 100f, 100, 100);
	}

	public static BeamEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		BeamEntity entityarrow = new BeamEntity(SuggestionsannesfansModEntities.BEAM.get(), entity, world, null);
	...
	public static BeamEntity shoot(LivingEntity entity, LivingEntity target) {
		BeamEntity entityarrow = new BeamEntity(SuggestionsannesfansModEntities.BEAM.get(), entity, entity.level(), null);
