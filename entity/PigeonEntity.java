...
public class PigeonEntity extends Animal {
	public PigeonEntity(EntityType<PigeonEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		PigeonEntity retval = SuggestionsannesfansModEntities.PIGEON.get().create(serverWorld, EntitySpawnReason.BREEDING);
	...
	public boolean isFood(ItemStack stack) {
		return Ingredient.of(HolderSet.emptyNamed(BuiltInRegistries.ITEM, ItemTags.create(ResourceLocation.parse("minecraft:meat")))).test(stack);
	}
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(SuggestionsannesfansModEntities.PIGEON.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
