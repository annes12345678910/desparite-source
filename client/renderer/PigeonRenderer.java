...
public class PigeonRenderer extends MobRenderer<PigeonEntity, ChickenRenderState, ChickenModel> {
	...
	@Override
	public void extractRenderState(PigeonEntity entity, ChickenRenderState state, float partialTicks) {
	...
	public ResourceLocation getTextureLocation(ChickenRenderState state) {
		return ResourceLocation.parse("suggestionsannesfans:textures/entities/pigeon.png");
	}
}
